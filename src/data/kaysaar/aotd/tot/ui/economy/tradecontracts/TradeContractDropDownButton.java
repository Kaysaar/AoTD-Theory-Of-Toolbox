...
public class TradeContractDropDownButton extends DropDownButton {
    ...
    public TradeContractDropDownButton(UITableImpl tableOfReference, float width, float height, float maxWidth, float maxHeight, AoTDTradeContract contract,boolean browsingMode) {
    ...
    public void createUIContent() {
        ...
        mainButton = new TradeContractCustomButton(width,height,contract,0f, Misc.getBasePlayerColor(),Misc.getDarkPlayerColor(),Misc.getBrightPlayerColor(),browsingMode);
        mainButton.createUI();
