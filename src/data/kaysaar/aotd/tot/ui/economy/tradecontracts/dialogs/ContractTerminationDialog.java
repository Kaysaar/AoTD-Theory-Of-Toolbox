...
public class ContractTerminationDialog extends BasePopUpDialog {
    ...
    public ContractTerminationDialog(String headerTitle, DetailedTradeContractUI contractUI,AoTDTradeContract contract) {
        super(headerTitle);
    ...
    public void createContentForDialog(TooltipMakerAPI tooltip, float width) {
        ...
        if(!contract.isIssuedByPlayer()){
            tooltip.addPara("Termination of this contract will bring consequences!",3f).setAlignment(Alignment.MID);

        }
        else{
            tooltip.addPara("Termination will end this agreement with no additional consequences.", 3f)
