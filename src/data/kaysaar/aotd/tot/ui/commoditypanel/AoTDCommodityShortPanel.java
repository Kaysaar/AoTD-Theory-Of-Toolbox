...
public class AoTDCommodityShortPanel implements ExtendedUIPanelPlugin {
    ...
    public AoTDCommodityShortPanel(String commodityId, int number, Color textColor, float width,boolean demandMode) {
        this.commodityId = commodityId;
        this.number = number;
        this.textColor = textColor;
        this.width = width;
    ...
    public AoTDCommodityShortPanel(String commodityId, int number, Color textColor, float width, Industry market,boolean demandMode,boolean ignoreDeficit) {
        this.commodityId = commodityId;
        this.number = number;
        this.textColor = textColor;
        this.width = width;
    ...
    public AoTDCommodityShortPanel(String commodityId, int number, Color textColor, float width,boolean demandMode,boolean shortMode) {
        this.commodityId = commodityId;
        this.number = number;
        this.textColor = textColor;
        this.width = width;
    ...
    public AoTDCommodityShortPanel(String commodityId, int number, Color textColor, float width,boolean demandMode,boolean shortMode,boolean ignoreDemand) {
        this.commodityId = commodityId;
        this.number = number;
        this.textColor = textColor;
        this.width = width;
    ...
    public AoTDCommodityShortPanel(String commodityId, Color textColor, float width,AoTDTradeContract.TradeContractData contract,String contractId,boolean ignoreDemand) {
        this.commodityId = commodityId;
        this.textColor = textColor;
    ...
    public void createUI() {
        ...
        if (!demandMode) {
            tooltip.addPara(AoTDToolboxMisc.getDGSStringWithSign(number), textColor, 13f).setAlignment(al);
            ...
            if (def > 0&&!ignoreDeficit) {
                ...
                int min = Math.min(
                        market.getMarket().getCommodityData(commodityId).getDeficitQuantity(),
                        AoTDCommodityEconSpecManager.getEconSpec(commodityId)
                                .getCalculationScript()
                                .getRawUnitsFromDemand(stat, market.getMarket(), commodityId,market)
                );
            ...
            int def = AoTDSectorProductionDemandDataUtils.getTotalProductionFromFaction(commodityId, Factions.PLAYER)-AoTDSectorProductionDemandDataUtils.getTotalDemandFromFactionTillContract(commodityId,Factions.PLAYER,contractId);
            def*=-1;
