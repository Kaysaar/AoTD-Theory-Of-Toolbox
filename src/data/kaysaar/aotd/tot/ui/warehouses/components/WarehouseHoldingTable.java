...
public class WarehouseHoldingTable extends UITableImpl {
    ...
    public WarehouseHoldingTable(float width, float height, boolean doesHaveScroller, float xCord, float yCord) {
        ...
        if (dropDownButtons.isEmpty()) {
            ...
            for (MarketAPI system : systems) {
                WarehouseDropDown button = new WarehouseDropDown(this, width-13 , 75, 0, 0,system);
    ...
    public void createSections() {
        ...
        buttonData = tooltipOfButtons.addAreaCheckbox("Location", SortingState.NON_INITIALIZED, base, bg, bright, widthMap.get("location"), 20, 0f);
        buttonIncome = tooltipOfButtons.addAreaCheckbox("Data", SortingState.NON_INITIALIZED, base, bg, bright, widthMap.get("data"), 20, 0f);
        buttonAdmin = tooltipOfButtons.addAreaCheckbox("Upkeep", SortingState.DESCENDING, base, bg, bright, widthMap.get("upkeep"), 20, 0f);
