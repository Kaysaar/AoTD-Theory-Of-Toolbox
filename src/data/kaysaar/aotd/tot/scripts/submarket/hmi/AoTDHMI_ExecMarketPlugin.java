...
public class AoTDHMI_ExecMarketPlugin extends HMI_ExecMarketPlugin {
    public int getStockpileLimit(CommodityOnMarketAPI com) {
        ...
        if (!com.getCommodity().getId().equals("ore") && !com.getCommodity().getId().equals("rare_ore") && !com.getCommodity().getId().equals("organics") && !com.getCommodity().getId().equals("volatiles") && !com.getCommodity().getId().equals("organs") && !com.getCommodity().getId().equals("drugs") && !com.getCommodity().getId().equals("hand_weapons") && !com.getCommodity().getId().equals("marines")) {
            limit *= 0.25F;
        } else {
            limit *= 1.5F;
        }
